---
sidebar_position: 2
sidebar_label: Purchase A Bond (1, 1)
---
...
The former are called [liquidity bonds](../../literature-content/glossary#liquidity-bonds) and the latter [reserve bonds](../../literature-content/glossary#reserve-bonds).
