...
The former are called [liquidity bonds](/gitbook/assets/references/glossary#liquidity-bonds) and the latter [reserve bonds](../../references/glossary#reserve-bonds).
