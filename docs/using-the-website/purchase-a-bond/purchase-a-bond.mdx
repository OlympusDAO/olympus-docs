...
The former are called [liquidity bonds](/gitbook/assets/references/glossary.md#liquidity-bonds) and the latter [reserve bonds](../../references/glossary.md#reserve-bonds).
