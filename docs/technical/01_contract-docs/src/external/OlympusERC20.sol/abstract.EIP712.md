...
This contract implements the EIP 712 domain separator ([_domainSeparatorV4](/main/technical/contract-docs/src/external/OlympusERC20.sol/abstract.EIP712#_domainseparatorv4)) that is used as part of the encoding
...
This hash can be used together with [ECDSA-recover](/main/technical/contract-docs/src/external/OlympusERC20.sol/library.ECDSA#recover) to obtain the signer of a message. For example:
