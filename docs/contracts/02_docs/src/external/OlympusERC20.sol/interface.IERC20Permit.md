...
Adds the [permit](/main/contracts/docs/src/external/OlympusERC20.sol/interface.IERC20Permit#permit) method, which can be used to change an account's ERC20 allowance (see {IERC20-allowance}) by
