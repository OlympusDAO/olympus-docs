...
[Git Source](https://github.com/OlympusDAO/olympus-v3/blob/8f211f9ca557f5c6c9596f50d3a90d95ca98bea1/src/external/OlympusERC20.sol)
...
Adds the [permit](/main/contracts/docs/src/external/OlympusERC20.sol/abstract.ERC20Permit#permit) method, which can be used to change an account's ERC20 allowance (see [IERC20-allowance](/main/contracts/docs/src/interfaces/Uniswap/IUniswapV2ERC20.sol/interface.IUniswapV2ERC20#allowance)) by
presenting a message signed by the account. By not relying on `[IERC20-approve](/main/contracts/docs/src/external/ClaimTransfer.sol/contract.ClaimTransfer#approve)`, the token holder account doesn't
