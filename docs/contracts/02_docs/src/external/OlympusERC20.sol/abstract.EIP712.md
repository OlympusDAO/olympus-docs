...
This hash can be used together with [ECDSA-recover](/main/contracts/docs/src/external/OlympusERC20.sol/library.ECDSA#recover) to obtain the signer of a message. For example:
