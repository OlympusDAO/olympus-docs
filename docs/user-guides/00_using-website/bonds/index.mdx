---
title: "How to Buy Discounted OHM with Bonds"
description: "Bonds let users buy OHM from the protocol at a discount by trading in assets such as liquidity tokens. A user guide to bonding on the Olympus website."
sidebar_position: 2
...
The former are called [liquidity bonds](../../../contracts-old/glossary.md#liquidity-bonds) and the latter [reserve bonds](../../../contracts-old/glossary.md#reserve-bonds).
...
- _An "Approve" transaction is needed when bonding an asset for the first time; this transaction gives the [Olympus bond contract](../../../contracts-old/bonds.md) the permission to execute the bond. Subsequent bonding only requires you to perform the "Bond" transaction._
