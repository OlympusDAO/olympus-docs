---
title: "How to Buy a Bond (OHM-ETH Bond Tutorial)"
description: "A step-by-step walkthrough of purchasing an OHM-ETH liquidity bond on the Olympus website, from selecting the bond to claiming vested OHM."
sidebar_label: "Example: How to Buy A Bond"
sidebar_position: 2
---

# Example: How to Buy A Bond

This tutorial will be given for an OHM-ETH bond, which is a [liquidity bond](../../../contracts-old/glossary.md#liquidity-bonds).
