---
title: "How to Stake OHM on Olympus"
description: "How to stake OHM for gOHM on the Olympus website, including the wrapping process and what gOHM is used for (governance voting and Cooler Loans collateral)."
...
This page describes the legacy rebasing staking interface. Rebasing is no longer in effect; see the current overview docs before using this as current protocol guidance.
:::
...
<YouTube youTubeId="aXAE1ikVMpM" alt="How to get OHM and stake it on Olympus" />
...
2\. Make sure the output currency is OHM. You can also copy and paste the [OHM contract address](../../contracts-old/tokens.md#ohm) into the output currency field to ensure you are swapping for the right token.
...
6\. You should see OHM in your wallet balance now after the swap transaction is successful. If you cannot find it in your wallet, add [OHM contract address](../../contracts-old/tokens.md#ohm) to your wallet.
